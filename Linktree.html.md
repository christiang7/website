...
<head>
    <meta charset="UTF-8">
    <title>Linktree of Christian Gößl</title>
...
<video autoplay muted loop id="myVideo">
  <source src="./Media/latest_1024_fade.mp4" type="video/mp4">
</video>
    <style>
    body {
        color: #d8dee9;
  ...
  padding: 0;
    ...
    <div class="linktree" align=center style="text-align: center;">
        <br>
        <img class="img avatar" src="./Media/Profilbild-Website-small2.jpg" alt="avatar">
        <br>
        <p style="font-size:40px;">Christian Gößl</p>
        <p style="font-size:35px;">A space wizard </br> Ad Astra per Aspera</p>
        <br>
    ...
    <button class="button button1" onclick="window.location.href='./Media/Lebenslauf.pdf';"><img src="./Media/icons/website-click-svgrepo-com.svg" alt="" height="36px" float="left"> Lebenslauf deutsch</button>  <br>
    <button class="button button1" onclick="window.location.href='https://kanoa.de/@christian_1';"><img src="./Media/icons/mastodon-svgrepo-com.svg" alt="" height="36px" float="left"> Mastodon</button>  <br>
    <button class="button button1" onclick="window.location.href='';"><img src="./Media/icons/email-svgrepo-com.svg" alt="" height="36px" float="left"> Email - christian.g at mailbox.org</button>  <br>
    <button class="button button1" onclick="window.location.href='https://pixelshot.it/christian';"><img src="./Media/icons/pixelfed-svgrepo-com-1.svg" alt="" height="36px" float="left"> Pixelfed</button>  <br>
    <button class="button button1" onclick="window.location.href='https://clip.place/a/christian/video-channels';"><img src="./Media/icons/peertube-svgrepo-com-1.svg" alt="" height="36px" float="left"> Peertube</button>  <br><br><br><br>
    </div>
</body>
</html>
